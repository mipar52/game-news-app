...
extension Color {
    ...
    static let appRed = Color(red: 0.90 , green: 0.42 , blue: 0.44 )
    static let appYellow = Color(red: 0.92 , green: 0.67 , blue: 0.55 )
    static let appOrange = Color(red: 0.91 , green: 0.44 , blue: 0.32 )
}
